	...
	<view>
		<view style="display: flex;flex-direction: row;width: 100%;height: 100%;align-items: center;">
			...
			<view class="phone">
				...
				<text style="font-size: 13px;">检测详情</text>
					...
					<view style="width: 100%;display: flex;flex-direction: column;margin-top: 60rpx;">
						<view style="display: flex;flex-direction: row;align-items: center;">
							...
							<view style="width: 100%;margin-top: 15rpx;margin-left: 10px;">
								<input disabled="true" style="background-color: #e1e1e1;" class="input_group" placeholder="文化西路与山大路交汇处东20M" v-model="title"/>
							</view>
						</view>
						...
						<view style="display: flex;flex-direction: row;align-items: center;margin-top: 10px;">
							...
							<view style="width: 100%;margin-top: 15rpx;margin-left: 10px;">
								<input disabled="true" style="background-color: #e1e1e1;" class="input_group" placeholder="" v-model="road_name"/>
							</view>
						</view>
						...
						<view style="display: flex;flex-direction: row;align-items: center;margin-top: 20px;">
							...
							<view style="width: 100%;">
								<textarea disabled="true" style="background-color: #e1e1e1;"  class="text_filed" placeholder="无" v-model="detail"></textarea>
							</view>
						</view>
						<br><hr>
						...
						<view style="display: flex;flex-direction: column;align-items: center;margin-top: 10px;">
							...
							<view style="display: flex;flex-direction: row;font-size: 13px;">
								<view style="text-align: center;">
									<text >原图</text>
									<image src="http://pan.tanfuhua.com/data/User/admin/home/pictures/1.jpg" style="width: 120px;height: 90px;"></image>
								</view>
								
								<view style="text-align: center;">
									<text >检测结果图</text>
									<image src="http://pan.tanfuhua.com/data/User/admin/home/pictures/11.png" style="width: 120px;height: 90px;"></image>
								</view>
								<view style="text-align: center;width: 70px;">
									<text style="color: red;">检测结果</text>
									<view style="height: 100px;display: flex;flex-direction: column;justify-content: center;">
										<text style="color: red;">裂纹</text>
									</view>
								</view>
...
<script>
	export default {
		...
		mounted() {
			...
			this.detail = temp[0].detail;
			this.title = temp[0].title;
			this.location = temp[0].location;
			this.road_name = temp[0].road_name;
			this.image = temp[0].image;
			// this.loadhuancun();
		},
		methods: {
			dialogConfirm(){
